<template>
  <div class="option-items-pane">
    ...
    <el-checkbox-group
      v-else-if="
        selectedWidget.type === 'checkbox' || (selectedWidget.type === 'select' && selectedWidget.options.multiple)
      "
      v-model="optionModel.defaultValue"
      @change="emitDefaultValueChange"
    >
    ...
    <el-cascader
      ...
      :props="{ multiple: optionModel.multiple }"
      @change="emitDefaultValueChange"
...
.el-button--mini.is-circle.col-delete-button {
  padding: 2px;
  margin-left: 5px;
}
</style>
